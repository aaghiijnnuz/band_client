...
public class TitleBar extends RelativeLayout{
	...
	public void setBtnLeft(int icon,int txtRes){
		...
		int height=com.example.util.SystemMethod.dip2px(mContext, 20);
	...
	public void setBtnRight(int icon){
		Drawable img=mContext.getResources().getDrawable(icon);
		int height=com.example.util.SystemMethod.dip2px(mContext, 30);
		int width=img.getIntrinsicWidth()*height/img.getIntrinsicHeight();
		img.setBounds(0, 0, width, height);
	...
	@SuppressLint("NewApi")
	public void setPopWindow(PopupWindow mPopWindow,TitleBar titleBaarView){
