...
public class MyLog {
	...
	private static char MYLOG_TYPE = 'v';// 输入日志类型，w代表只输出警告信息，v代表输出所有信息
	...
	private static SimpleDateFormat logfile = new SimpleDateFormat("yyyy-MM-dd");// 日志的文件格式
	...
	private static void writeLogtoFile(String mylogtype, String tag, String text) {// 新建或打开日志文件
		...
		File file = new File(MYLOG_PATH_SDCARD_DIR, needWriteFiel
				+ MYLOGFILEName);
		try {
			FileWriter filerWriter = new FileWriter(file, true);// 后面这个参数代表是否要接上文件中的数据，不进行覆盖
